...
class HashTable:
    ...
    """"이 메소드는 파라미터로 key를 받아서 key를 가지고 있는
        링크드 리스트 노드를 리턴합니다. 첫 째줄에서는 배열의
        원하는 인덱스에 있는 링크드 리스트를 가지고 옵니다.
        둘 째줄에서는 링크드 리스트 안에서 원하는 key를 갖고
        있는 노드를 탐색해서 리턴합니다."""
    """이건 그니까 101:최지웅 둘다 리턴이 되는 메소드"""
...
print(test_scores._get_linked_list_for_key("태호"))
print(test_scores.look_up_value("태호"))